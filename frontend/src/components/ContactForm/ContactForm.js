...
const ContactForm = () => {
  return (
    <div className='flex flex-row items-center justify-center lg:px-10'>
      ...
      <h1 className='lg:text-5xl poppins-bold text-2xl text-left text-[#159D86]'>Join us</h1>
      <p className='text-[#159D86] poppins-medium'>Do you want to join our team?</p>

      <div className=' name flex flex-col lg:flex-row pt-10 gap-3  items-center lg:w-3/5 justify-between'>
      ...
      <div className=' email flex flex-col py-6  '>
        ...
        <input id='email' className='rounded-lg p-3 border border-gray-300 lg:w-3/5 ' placeholder='Email address'/>
      ...
      <div className=' message flex   flex-col py-2'>
        ...
        <textarea id='message' className='rounded-lg p-3 border border-gray-300 lg:w-3/5  outline-none ' placeholder='Enter your questions or message' />
        


      </div>

      <div className='bg-[#159D86] text-center lg:w-3/5 rounded-lg p-2 mt-5'>
