  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-4  lg:top-7 lg:left-[900px] left-52   h-full flex flex-col items-center justify-center text-white">
        ...
        <div className="lg:mt-3 lg:p-2 cursor-pointer rounded-lg hover:bg-white hover:text-[#1D8E8E]   text-white bg-[#1D8E8E]  lg:rounded-lg">
          <h1 className="lg:text-lg text-sm poppins-bold">Plan Your Trip</h1>
        </div>
      </div>
    </div>
  );
